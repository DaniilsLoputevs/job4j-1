...
insert into prod(name, type_id, data_exp, price) VALUES ('мороженное стаканчик',2,'2019-09-19 12:00:00.000000',100);
insert into prod(name, type_id, data_exp, price) VALUES ('мороженное пломбир',2,'2019-09-19 12:00:00.000000',200);
insert into prod(name, type_id, data_exp, price) VALUES ('мороженное сникерс',2,'2019-09-19 12:00:00.000000',300);
 ...
 */
select * from prod as p where current_date+ interval '1 month' > data_exp;
...
select * from prod as p inner join type as t on p.type_id = t.id_type group by t.type_name  ;create database pruduct_01;
